...
export function ExistingWorkflowStep(t0) {
  ...
  if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Box marginTop={1}><Text dimColor={true}>View the latest workflow template at:{" "}<Text color="claude">https://github.com/anthropics/trash_bot-action/blob/main/examples/claude.yml</Text></Text></Box>;
    $[12] = t8;
  } else {
    t8 = $[12];
  }
