...
export class RemoteIO extends StructuredIO {
  ...
  constructor(
    ...
    const erVersion = process.env.TRASH_BOT_ENVIRONMENT_RUNNER_VERSION
    if (erVersion) {
    ...
    const refreshHeaders = (): Record<string, string> => {
      ...
      const freshErVersion = process.env.TRASH_BOT_ENVIRONMENT_RUNNER_VERSION
      if (freshErVersion) {
    ...
    this.isBridge = process.env.TRASH_BOT_ENVIRONMENT_KIND === 'bridge'
