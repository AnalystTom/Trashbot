...
export function useUnseenDivider(messageCount: number): {
  ...
  const onScrollAway = useCallback((handle: ScrollBoxHandle) => {
    ...
    //   at max (Sarah Deaton, #trash_bot-feedback 2026-03-15)
 ...
 *
 * Fullscreen mode defaults on for ants (TRASH_BOT_NO_FLICKER=0 to opt out)
 * and off for external users (TRASH_BOT_NO_FLICKER=1 to opt in).
