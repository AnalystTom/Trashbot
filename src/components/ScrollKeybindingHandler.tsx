...
// event/notch — users on those can set TRASH_BOT_SCROLL_SPEED=3 to match
...
/** Read TRASH_BOT_SCROLL_SPEED, default 1, clamp (0, 20].
 ...
 *  set TRASH_BOT_SCROLL_SPEED=3 to match vim/nvim/opencode. We can't
...
export function readScrollSpeedBase(): number {
  const raw = process.env.TRASH_BOT_SCROLL_SPEED;
  if (!raw) return 1;
