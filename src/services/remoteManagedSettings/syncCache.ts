 ...
 *   TRASH_BOT_OAUTH_TOKEN / FD, or keychain tokens missing metadata): Eligible —
...
export function isRemoteManagedSettingsEligible(): boolean {
  ...
  // Externally-injected tokens (CCD via TRASH_BOT_OAUTH_TOKEN, CCR via
  // TRASH_BOT_OAUTH_TOKEN_FILE_DESCRIPTOR, Agent SDK, CI) carry no
