 ...
 * Initialized during Trash Bot startup.
 */
 ...
 * asynchronously during Trash Bot startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Trash Bot startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/anthropics/trash_bot/issues/15521:
 ...
 *
 * This should be called during Trash Bot shutdown. Stops all running LSP servers
