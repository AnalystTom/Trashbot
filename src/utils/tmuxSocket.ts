...
async function doInitialize(): Promise<void> {
  ...
  // Pass TRASH_BOT_SKIP_PROMPT_HISTORY via -e so it's set in the initial shell environment
  //
  ...
  const result = await execTmux([
    ...
    'base',
    '-e',
    'TRASH_BOT_SKIP_PROMPT_HISTORY=true',
    ...(getPlatform() === 'windows'
  ...
  // Set TRASH_BOT_SKIP_PROMPT_HISTORY in the tmux GLOBAL environment (-g).
  ...
  // Any Trash Bot instance spawned on this socket will inherit this env var,
