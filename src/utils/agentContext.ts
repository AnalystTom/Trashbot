 ...
 * variables instead: TRASH_BOT_AGENT_ID, TRASH_BOT_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from TRASH_BOT_PARENT_SESSION_ID env var), undefined for main REPL subagents */
