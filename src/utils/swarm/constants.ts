 ...
 */
export const TEAMMATE_COMMAND_ENV_VAR = 'TRASH_BOT_TEAMMATE_COMMAND'
 ...
 */
export const TEAMMATE_COLOR_ENV_VAR = 'TRASH_BOT_AGENT_COLOR'
 ...
 */
export const PLAN_MODE_REQUIRED_ENV_VAR = 'TRASH_BOT_PLAN_MODE_REQUIRED'
