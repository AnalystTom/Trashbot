...
export const MACOS_BUNDLE_ID = 'com.anthropic.trash_bot-url-handler'
const APP_NAME = 'Trash Bot URL Handler'
const DESKTOP_FILE_NAME = 'trash_bot-url-handler.desktop'
const MACOS_APP_NAME = 'Trash Bot URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Trash Bot Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Trash Bot
