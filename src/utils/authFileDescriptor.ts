 ...
 * rationale. Env var: TRASH_BOT_OAUTH_TOKEN_FILE_DESCRIPTOR.
...
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'TRASH_BOT_OAUTH_TOKEN_FILE_DESCRIPTOR',
