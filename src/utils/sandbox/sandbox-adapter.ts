...
/**
 * Resolve Trash Bot-specific path patterns for sandbox-runtime.
 *
 * Trash Bot uses special path prefixes in permission rules:
...
/**
 * Convert Trash Bot settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Trash Bot started)
...
// scrubbed if they appear after a sandboxed command. See anthropics/trash_bot#29316.
 ...
 * bareGitRepoFiles. anthropics/trash_bot#29316.
 */
