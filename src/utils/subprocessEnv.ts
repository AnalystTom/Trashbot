...
const GHA_SUBPROCESS_SCRUB = [
  ...
  // trash_bot-action-specific duplicates — action JS consumes these during
 ...
 * servers, shell hooks).
 *
 * Gated on TRASH_BOT_SUBPROCESS_ENV_SCRUB. trash_bot-action sets this
...
export function subprocessEnv(): NodeJS.ProcessEnv {
  ...
  if (!isEnvTruthy(process.env.TRASH_BOT_SUBPROCESS_ENV_SCRUB)) {
