 ...
 * @param teamName - Optional team name (defaults to TRASH_BOT_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's TRASH_BOT_AGENT_ID */
  workerId: string
  /** Worker's TRASH_BOT_AGENT_NAME */
  workerName: string
  /** Worker's TRASH_BOT_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to TRASH_BOT_TEAM_NAME env var)
