 ...
 *
 * These helpers identify whether this Trash Bot instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.TRASH_BOT_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our TRASH_BOT_AGENT_ID matches the leadAgentId, OR
 *    - We have no TRASH_BOT_AGENT_ID set (backwards compat: the original
