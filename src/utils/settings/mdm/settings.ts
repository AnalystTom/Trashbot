/**
 * MDM (Mobile Device Management) profile enforcement for Trash Bot managed settings.
 *
 ...
 * - Linux: No MDM equivalent (uses /etc/trash_bot/managed-settings.json instead)
 *
