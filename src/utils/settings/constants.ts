...
/**
 * The JSON Schema URL for Trash Bot settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/trash_bot-settings.json
 */
export const TRASH_BOT_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/trash_bot-settings.json'
