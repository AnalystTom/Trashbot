 ...
 *
 * This module is responsible for discovering, loading, and validating Trash Bot plugins
...
async function installFromGitHub(
  ...
  const gitUrl = isEnvTruthy(process.env.TRASH_BOT_REMOTE)
 ...
 * TRASH_BOT_REMOTE) or any URL that passes validateGitUrl (https, http,
 * file, git@ ssh).
 */
 ...
 *
 * TRASH_BOT_SYNC_PLUGIN_INSTALL=1 delegates to the full loader — that
