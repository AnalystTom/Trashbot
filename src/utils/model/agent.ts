...
export function getAgentModel(
  ...
  if (process.env.TRASH_BOT_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.TRASH_BOT_SUBAGENT_MODEL)
  }
 ...
 * See https://github.com/anthropics/trash_bot/issues/30815.
 *
