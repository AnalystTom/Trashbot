...
//   protoc               unknown
// source: events_mono/trash_bot/v1/trash_bot_internal_event.proto
...
export interface EnvironmentMetadata {
  ...
  is_trash_bot_action?: boolean | undefined
  ...
  is_trash_bot_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  trash_bot_container_id?: string | undefined
  trash_bot_remote_session_id?: string | undefined
...
/**
 * ClaudeCodeInternalEvent represents events logged from Trash Bot via Statsig
...
function createBaseEnvironmentMetadata(): EnvironmentMetadata {
  return {
    ...
    arch: '',
    is_trash_bot_remote: false,
    remote_environment_type: '',
    trash_bot_container_id: '',
    trash_bot_remote_session_id: '',
    tags: [],
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      is_github_action: isSet(object.is_github_action)
        ...
        : false,
      is_trash_bot_action: isSet(object.is_trash_bot_action)
        ? globalThis.Boolean(object.is_trash_bot_action)
        : false,
      ...
      is_trash_bot_remote: isSet(object.is_trash_bot_remote)
        ? globalThis.Boolean(object.is_trash_bot_remote)
        : false,
      remote_environment_type: isSet(object.remote_environment_type)
        ? globalThis.String(object.remote_environment_type)
        : '',
      trash_bot_container_id: isSet(object.trash_bot_container_id)
        ? globalThis.String(object.trash_bot_container_id)
        : '',
      trash_bot_remote_session_id: isSet(object.trash_bot_remote_session_id)
        ? globalThis.String(object.trash_bot_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.is_trash_bot_action !== undefined) {
      obj.is_trash_bot_action = message.is_trash_bot_action
    }
    ...
    if (message.is_trash_bot_remote !== undefined) {
      obj.is_trash_bot_remote = message.is_trash_bot_remote
    }
    if (message.remote_environment_type !== undefined) {
      obj.remote_environment_type = message.remote_environment_type
    }
    if (message.trash_bot_container_id !== undefined) {
      obj.trash_bot_container_id = message.trash_bot_container_id
    }
    if (message.trash_bot_remote_session_id !== undefined) {
      obj.trash_bot_remote_session_id = message.trash_bot_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.is_trash_bot_action = object.is_trash_bot_action ?? false
    ...
    message.is_trash_bot_remote = object.is_trash_bot_remote ?? false
    message.remote_environment_type = object.remote_environment_type ?? ''
    message.trash_bot_container_id = object.trash_bot_container_id ?? ''
    message.trash_bot_remote_session_id =
      object.trash_bot_remote_session_id ?? ''
