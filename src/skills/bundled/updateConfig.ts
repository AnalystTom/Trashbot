...
\`\`\`
Plugin syntax: \`plugin-name@source\` where source is \`trash_bot-marketplace\`, \`claude-plugins-official\`, or \`builtin\`.
...
Hooks run commands at specific points in Trash Bot's lifecycle.
...
Modify Trash Bot configuration by updating settings.json files.
