...
export const DESCRIPTION = 'Get or set Trash Bot configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Trash Bot configuration settings.

  View or change Trash Bot settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
