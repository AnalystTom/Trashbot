 ...
 * TRASH_BOT_DISABLE_NONESSENTIAL_TRAFFIC are set; a `false` default would
 ...
 *
 * `TRASH_BOT_DISABLE_CRON` is a local override that wins over GB.
 */
export function isKairosCronEnabled(): boolean {
  return feature('AGENT_TRIGGERS')
    ? !isEnvTruthy(process.env.TRASH_BOT_DISABLE_CRON) &&
 ...
 * durable cron. Does NOT consult TRASH_BOT_DISABLE_CRON (that kills the whole
