...
async function handleBroadcast(
  ...
  if (!teamName) {
    throw new Error(
      'Not in a team context. Create a team with Teammate spawnTeam first, or set TRASH_BOT_TEAM_NAME.',
    )
  }
  ...
  if (!senderName) {
    throw new Error(
      'Cannot broadcast: sender name is required. Set TRASH_BOT_AGENT_NAME.',
    )
  }
